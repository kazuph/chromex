...
This Privacy Policy explains what data Chromex may process, why it is processed, and how the extension is designed to limit access to the user-requested task.
